...
namespace Blogs.Common.Helper
{
    ...
    public class CryptoHelper
    {
        ...
        public static string StaEncrypt(string clearText, string key = "ABCDEFGHIJKLMNOP")
        {
            CryptoHelper helper = new CryptoHelper(key);
            return helper.Encrypt(clearText);
        }

        public static string StaDecrypt(string encryptedText, string key = "ABCDEFGHIJKLMNOP")
        {
            CryptoHelper helper = new CryptoHelper(key);
